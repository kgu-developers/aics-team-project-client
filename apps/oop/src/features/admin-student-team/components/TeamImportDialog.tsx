...
import {
  useApplyAdminTeamImportMutation,
  usePreviewAdminTeamImportMutation,
} from '../queries';
  ...
  return (
    ...
    >
      <div className={styles.content}>
        <Heading level={2}>팀 명단 엑셀 업로드</Heading>
        ...
        {preview ? (
          <>
            <div className={styles.summary}>
              ...
              <Text>신규 {preview.summary.valid}건</Text>
              <Text>갱신 {preview.summary.update}건</Text>
